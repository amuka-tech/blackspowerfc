        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://vm.tiktok.com/ZS4dpEmaG/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-brand-gray flex items-center justify-center text-gray-400 hover:bg-brand-red hover:text-white transition-colors">
